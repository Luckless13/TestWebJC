...
// Test 5
    ...
    @When("User Input Judul Blog")
    public void user_input_judul_blog() {
        blogPage.setInputjudul("test QA Juara coding 3");
        extentTest.log(LogStatus.PASS, "Input judul blog");
    }

    @When("User Select Active atau No Active")
    ...
    @When("User Input Conten Preview")
    public void user_input_conten_preview() {
        blogPage.setInputcontent1("test QA Juara coding 3");
        extentTest.log(LogStatus.PASS, "Input Content preview");
    }

    @When("User Input Content")
    public void user_input_content() {
        blogPage.setInputcontent2("test QA Juara coding 3");
        extentTest.log(LogStatus.PASS, "Input Content");
    }

    @When("User Clik Simpan")
    ...
    public void data_berhasi_l_di_tambah() {
        ...
        extentTest.log(LogStatus.PASS, "berhasil di tambah");
    }
// Test 6
    @When("User click Blog Menu tc006")
    public void user_click_blog_menu_tc006() throws InterruptedException {
        blogPage.btnblog2();
        extentTest.log(LogStatus.PASS, "User click Blog Menu");
    }

    @When("User Click Tambah tc006")
    public void user_click_tambah_tc006() throws InterruptedException {
        blogPage.btntambah();
        extentTest.log(LogStatus.PASS, "User Click Tambah");
    }

    @When("User Clik Simpan tc006")
...
// Test 8
    ...
    public void user_input_conten_preview_tc008() {
        blogPage.setInputcontent1("test QA Juara coding tc3");
        extentTest.log(LogStatus.PASS, "Input Content preview");
    }
...
// Test 9
    ...
    public void user_input_judul_blog_tc009() {
        blogPage.setInputjudul("test QA Juara coding tc3");
        extentTest.log(LogStatus.PASS, "Input judul blog");
    }
...
// test 10
    ...
    public void user_input_judul_blog_tc010() {
        blogPage.setInputjudul("test QA Juara coding tc4");
        extentTest.log(LogStatus.PASS, "Input judul blog");
    }
